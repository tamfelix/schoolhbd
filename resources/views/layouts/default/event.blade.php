                    ...
                    {{--   news1     --}}
                            <div class="">
                                <div class="flex flex-col items-center">
                                    ...
                                    <div class="font3 text-xl text-[#7fa7cb] pl-4 mb-4">
                                        {{ $range[0][ 'title_'.app()->getLocale() ] }}
                                    </div>
                                    @if($range[0]['img'])
                                        <img src="{{ env('APP_URL').'/'.$range[0]['img'] }}" class="w-[400px] h-auto  my-4 frame" title="{{ $range[0][ 'title_'.app()->getLocale() ] }}" alt="{{ $range[0][ 'title_'.app()->getLocale() ] }}">
                                    @endif
                                </div>
...
{{--                                        LIKES--}}
                                        <form action="{{ url('elike') }}" method="GET">
                                            ...
                                            <button type="submit">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up ml-3 mr-1 mt-1" viewBox="0 0 16 16">
